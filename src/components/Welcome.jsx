    ...
    <div className="welcome" id="welcome">
      ...
      <section className="about">
        <div className="content">
          ...
          <p>
            Contact:{" "}
            <a href="mailto:travelandtourism57@gmail.com" target="_blank">
              Email
            </a>
          </p>
        </div>
      ...
      <div className="contact">
        ...
        <div className="contactWrapper">
          <div className="textFields">
            ...
            <span>
              Reach out to us at :{" "}
              <a href="mailto:travelandtourism57@gmail.com">
                travelandtourism57@gmail.com
              </a>
            </span>
          </div>
          <img
